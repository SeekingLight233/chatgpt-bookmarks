...
function SyncIcon(props: React.SVGProps<SVGSVGElement> & { loading?: boolean, color?: string }) {

  const { color = theme.iconTintColor, style = {}, loading = false } = props
